...
class Vgg19:
    ...
    def build_CAM(self):
        """
        Builds tensorflow functions to compute Class Activation Mapping (CAMs)
        either from class number or from preducted class
        """
        # Either work with the argmax(1) or with a given index(2)
        # (1) Get argmaxs of prob
